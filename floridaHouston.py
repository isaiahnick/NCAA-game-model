...
def load_data(filepath):
    ...
    return Houston_df, Florida_df, Houston_team_df, Florida_team_df
...
if __name__ == "__main__":
    filepath = "/Users/isaiahnick/Desktop/houstonFlorida.xlsx"  # Update path as needed
    results = main(filepath, "Houston", "Florida", "team1")